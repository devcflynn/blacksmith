...
As you begin to generate you may notice some interfaces and classes referenced in templates that were not generated.  This is not a mistake.  Any classes you only create one time are not generated by Blacksmith and can be obtained from [Blacksmith-contracts](https://github.com/Indatus/blacksmith-contracts).
